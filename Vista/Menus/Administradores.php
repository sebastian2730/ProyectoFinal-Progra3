                ...
                <div class="col-lg-9  d-none d-lg-block">
                    <div class="horizontal-menu">
                        <nav>
                            <ul id="nav_menu">
                                <li>
                                    <a href="javascript:void(0)"><i class="ti-dashboard"></i><span>Usuarios</span></a>
                                    <ul class="submenu">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><i class="ti-layout-sidebar-left"></i><span>Estudiantes</span></a>
                                    <ul class="submenu">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><i class="ti-pie-chart"></i><span>Materias</span></a>
                                    <ul class="submenu">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><i class="ti-pie-chart"></i><span>Periodos</span></a>
                                    <ul class="submenu">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><i class="ti-pie-chart"></i> <span>Promedios</span></a>
                                    <ul class="submenu">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><i class=""></i> <span>Cerrar Sesion</span></a>
                                    <ul class="submenu">
