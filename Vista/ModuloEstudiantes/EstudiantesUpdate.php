            ...
            <div class="container">
                <div class="row">
                  ...
                  <div class="col-12 mt-5">
                      <div class="card">
                          <div class="card-body">
                              <h4 class="header-title">Editar Estudiantes</h4>
                              <form action="../Vista/ModuloEstudiantes/EstudiantesUpdate.php" method="POST">
                                <div class="form-group">
                                     <input class="form-control"  type="text" name="buscar" placeholder="Buscar" id="example-text-input"required>
                                </div>
                                  <button class="btn btn-primary mt-4 pr-4 pl-4" type="submit" name="btn_EditarEstudiante" value="Buscar">Buscar</button>
                              </form>
                          </div>
                      </div>
                  </div>
